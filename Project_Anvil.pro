...
unrealRootPath=/mnt/95c77047-fc78-4a40-889e-0b9085d4a262/unreal_Engine/UnrealEngine-4.25.4-release
Project_AnvilRootPath=/mnt/95c77047-fc78-4a40-889e-0b9085d4a262/Project_Anvil/Project-Anvil

gameProjectFile=/mnt/95c77047-fc78-4a40-889e-0b9085d4a262/Project_Anvil/Project-Anvil/Project_Anvil.uproject
...
include(Project_AnvilSource.pri)
include(Project_AnvilHeader.pri)
include(Project_AnvilConfig.pri)
include(Project_AnvilIncludes.pri)
include(Project_AnvilDefines.pri)

Project_Anvil-Linux-Debug.commands = $$build Project_Anvil Linux Debug  -project="\"$$gameProjectFile\"" $$args
Project_Anvil-Linux-DebugGame.commands = $$build Project_Anvil Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Project_Anvil-Linux-Shipping.commands = $$build Project_Anvil Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Project_Anvil-Linux-Test.commands = $$build Project_Anvil Linux Test  -project="\"$$gameProjectFile\"" $$args
Project_Anvil.commands = $$build Project_Anvil Linux Development  -project="\"$$gameProjectFile\"" $$args

Project_AnvilEditor-Linux-Debug.commands = $$build Project_AnvilEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
Project_AnvilEditor-Linux-DebugGame.commands = $$build Project_AnvilEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Project_AnvilEditor-Linux-Shipping.commands = $$build Project_AnvilEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Project_AnvilEditor-Linux-Test.commands = $$build Project_AnvilEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
Project_AnvilEditor.commands = $$build Project_AnvilEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	Project_Anvil-Linux-Debug \
	Project_Anvil-Linux-DebugGame \
	Project_Anvil-Linux-Shipping \
	Project_Anvil-Linux-Test \
	Project_Anvil \
	Project_AnvilEditor-Linux-Debug \
	Project_AnvilEditor-Linux-DebugGame \
	Project_AnvilEditor-Linux-Shipping \
	Project_AnvilEditor-Linux-Test \
	Project_AnvilEditor \
