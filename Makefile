...
Project_Anvil-Linux-Debug:
	 $(PROJECTBUILD) Project_Anvil Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Project_Anvil-Linux-DebugGame:
	 $(PROJECTBUILD) Project_Anvil Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Project_Anvil-Linux-Shipping:
	 $(PROJECTBUILD) Project_Anvil Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Project_Anvil-Linux-Test:
	 $(PROJECTBUILD) Project_Anvil Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Project_Anvil:
	 $(PROJECTBUILD) Project_Anvil Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

Project_AnvilEditor-Linux-Debug:
	 $(PROJECTBUILD) Project_AnvilEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Project_AnvilEditor-Linux-DebugGame:
	 $(PROJECTBUILD) Project_AnvilEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Project_AnvilEditor-Linux-Shipping:
	 $(PROJECTBUILD) Project_AnvilEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Project_AnvilEditor-Linux-Test:
	 $(PROJECTBUILD) Project_AnvilEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Project_AnvilEditor:
	 $(PROJECTBUILD) Project_AnvilEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
